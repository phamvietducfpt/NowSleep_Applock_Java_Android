...
public class NotificationUtil {
    ...
    private static final String NOTIFICATION_CHANNEL_ID = "VietducApp";


    @RequiresApi(api = Build.VERSION_CODES.O)
    public static void createNotification(Service mContext,String title, String message) {
        Intent resultIntent = new Intent(mContext, SettimeActivity.class);
        ...
        NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID, "NowSleep background task ", importance);
