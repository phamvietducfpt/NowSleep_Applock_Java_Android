...
import com.PVD.NowSleep.model.FaviterInfo;
...
//            NotificationUtil.createNotification(this,"App Lock","App lock Services running in background");
        boolean applist = SpUtil.getInstance().getBoolean(AppConstants.Load_App_List_Service, true);
        if(applist){
            NotificationUtil.createNotification(this, "Now Sleep", "Load app list");
