...
public class AppConstants {
    ...
    public static final String Alarm_Receiver = "alarm_receiver"; //boolean
    public static final String start_lock_task = "start_lock_task"; //boolean
    public static final String Load_App_List_Service = "app_list"; //boolean
